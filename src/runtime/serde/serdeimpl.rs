...
// Go writes int8 as its raw two's-complement byte. Wider signed integers use
// the sign-bit XOR encoding so their lexicographic byte order is sortable.
signed_serde!(Int8Serde, i8, u8, 1, 0x00);
